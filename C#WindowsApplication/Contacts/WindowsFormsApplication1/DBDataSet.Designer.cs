...
namespace WindowsFormsApplication1 {
    ...
    public partial class DBDataSet : global::System.Data.DataSet {
        ...
        public partial class ContactsDataTable : global::System.Data.TypedTableBase<ContactsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ContactsRow AddContactsRow(string FirstName, string LastName, string Phone, string Mobile, string Address) {
...
namespace WindowsFormsApplication1.DBDataSetTableAdapters {
    ...
    public partial class ContactsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Contacts` WHERE ((`ContactId` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `Phone` IS NULL) OR (`Phone` = ?)) AND ((? = 1 AND `Mobile` IS NULL) OR (`Mobile` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Contacts` (`FirstName`, `LastName`, `Phone`, `Mobile`, `Address`) VA" +
                "LUES (?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Contacts` SET `FirstName` = ?, `LastName` = ?, `Phone` = ?, `Mobile` = ?, `Address` = ? WHERE ((`ContactId` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `Phone` IS NULL) OR (`Phone` = ?)) AND ((? = 1 AND `Mobile` IS NULL) OR (`Mobile` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ContactId, FirstName, LastName, Phone, Mobile, Address FROM Contacts";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "UPDATE    Contacts\r\nSET              FirstName = ?, LastName = ?, Phone = ?, Mobi" +
                "le = ?, Address = ?\r\nWHERE     (ContactId = ?)";
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Mobile", global::System.Data.OleDb.OleDbType.WChar, 255, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Mobile", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_ContactId", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ContactId", global::System.Data.DataRowVersion.Original, false, null));
        }
        ...
        public virtual int Delete(int Original_ContactId, string Original_FirstName, string Original_LastName, string Original_Phone, string Original_Mobile, string Original_Address) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Phone, string Mobile, string Address) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Phone, string Mobile, string Address, int Original_ContactId, string Original_FirstName, string Original_LastName, string Original_Phone, string Original_Mobile, string Original_Address) {
            if ((FirstName == null)) {
        ...
        public virtual int UpdateQuery(string FirstName, string LastName, string Phone, string Mobile, string Address, int Original_ContactId) {
            ...
            command.Parameters[5].Value = ((int)(Original_ContactId));
